...
export default function About() {
  return (
    <section id="o-nas" className="py-20 sm:py-28 bg-gray-50">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="group/card relative overflow-hidden rounded-2xl bg-white p-6 shadow-sm border border-gray-100 text-center hover:shadow-lg hover:-translate-y-1.5 hover:bg-green-50 hover:border-green-200 transition-all duration-300 cursor-default"
              >
                ...
                <div className="relative">
                  ...
                  <p className="mt-3 text-2xl font-bold text-gray-900 group-hover/card:scale-110 transition-transform duration-300 origin-center">
                    {stat.value}
                  </p>
