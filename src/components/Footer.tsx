        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-gray-400">
              Profesjonalna opieka medyczna w jednym miejscu. Zaufaj
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li className="flex gap-3 text-sm">
                ...
                <span>ul. Zdrowia 12, 00-001 Warszawa</span>
              </li>
              <li className="flex gap-3 text-sm">
              ...
              <li className="flex gap-3 text-sm">
                ...
                <a href="mailto:kontakt@medcare.pl" className="hover:text-primary-400 transition-colors">
                  kontakt@medcare.pl
                </a>
              </li>
            </ul>
